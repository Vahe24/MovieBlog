...
namespace MovieBlog.Controllers
{
    public class AdminMovieController : Controller
    {
        ...
        public AdminMovieController(IHostingEnvironment IHostingEnvironment, ApplicationContext d)
        {
        ...
        public IActionResult AdminMovie()
        {
            ...
            {
                ViewBag.AdminMovie = db.AdminMovies.ToList();
                return View();
            }
            else
            {
        ...
        [HttpPost]
        public IActionResult AdminMovie(Movie model)
        {
        ...
        {
            Movie slider = db.AdminMovies.Find(hid);
            if (slider != null)
            {
                db.AdminMovies.Remove(slider);
                db.SaveChanges();
            }
            ViewBag.AdminMovie = db.AdminMovies.ToList();
